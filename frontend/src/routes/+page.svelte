    ...
    <div class="container" style="margin-top: 1%;">
        {#if show_token_section == true}
            <div class="row" style="margin-bottom: 1%;">
                <h3>
                    List your followers and following from github using OAUTH
                </h3>
                <p>
                    To use this functionality, you have to go to the github developers section: <a href="https://github.com/settings/developers">https://github.com/settings/developers</a>,
                    create an OAUTH APP to get Client Id and Secret, and add <strong>http://localhost:12345</strong> in the "Authorization callback URL" field.
                </p>
            </div>
            <Form>
                <FormGroup>
        ...
        {#if show_gh_section == true}
            <div class="row">
                <div class="col-md-6" style="display: flex;">
                    <h3>Github info for the user:</h3> <img src={user_info.avatar_url} alt="Imagen de {user_info.login}" /><a href={user_info.html_url}><h3>{user_info.login}</h3></a>
                </div>
            </div>
            <div class="row">
                <h3>Bio: {user_info.bio}</h3>
            </div>     
            <Button color="warning" on:click={refreshGh}>Reload</Button>
            <Button color="danger" on:click={revokeAccess}>Clean credentials</Button>
